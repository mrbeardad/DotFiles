...
> 没转移，又臭又长。。。  
>
> **NOTE**!!!!!: 笔记里插入有$L^AT_EX$公式(github不支持)，<div title="别问我为啥要加中文，，.">调用api的话没法在公式里用中文</div>
> 所以各位记得给你的chrome安个[插件](https://github.com/orsharir/github-mathjax/issues/24#issuecomment-438140315)，
> 该插件若从chrome商店安装的话要出问题，记得clone下来手动安装，链接里的issue写了
...
<img align="right" src="../images/csapp24.png"></img>
