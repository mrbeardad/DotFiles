...
net.ipv6.conf.lo.disable_ipv6 =1" >> /etc/sysctl.conf'
    ...
    #GNOME扩展
    yay -S sweet-theme-git breeze-adapta-cursor-theme-git  gnome-shell-extension-coverflow-alt-tab-git gnome-shell-extension-system-monitor-git gnome-shell-extension-dash-to-dock-git gnome-shell-extension-dash-to-panel-git gnome-shell-extension-lockkeys-git adobe-source-han-sans-cn-fonts
    # yay -S gtk-theme-macos-mojave adapta-gtk-theme-bin ttf-google-fonts-git breeze-hacked-cursor-theme
}
